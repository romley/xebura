...
<title>Create Message - Xebura.com</title>
...
<h2>Create Message</h2>
  <form id="create_msg" name="create_msg" method="post" action="">
    

			<textarea cols="80" id="editor1" name="html_template" rows="30">{$html_msg}</textarea>
            {literal}
			<script type="text/javascript">
			//<![CDATA[
    ...
    <a href="select_list?i={$cid}">NEXT - SELECT TARGET LISTS</a>
