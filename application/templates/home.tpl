...
<script type="text/javascript" charset="utf-8">
			$(document).ready(function() {
				cTable = $('#campaigns').dataTable( {
					...
					$(cTable.fnGetNodes()).click( function () {
					var iPos = cTable.fnGetPosition( this );
					var cData = bSettings.aoData[ iPos ]._aData;
					window.location="edit_campaign?i="+cData[0];
					} );
					}
...
<script type="text/javascript" charset="utf-8">
			$(document).ready(function() {
				bTable = $('#reports').dataTable( {
					"bProcessing": true,
					"sAjaxSource": 'report_chart?list=all',
					"aaSorting": [[ 2, "desc" ]],
					"bPaginate": true,
					"bLengthChange": true,
					"bFilter": true,
					...
					window.location="report_detail?i="+aData[0];
					} );
					}
...
<!-- CAMPAIGNS -->
<button class="add_campaign"  id="addcampaign" name="Add Campaign" value="Add Campaign" >Create New Campaign</button>
...
<div id="top-scores">
  <div id="boxreports" style="font-size:12px;font-weight:normal;margin-top:10px;">
    <div id="dynamic">
      ...
      <table cellpadding="0" cellspacing="0" border="0" class="display" id="campaigns" style="font-size:12px;font-weight:normal;">
        <thead>
...
<div id="top-scores">
  <div id="boxreports" style="font-size:12px;font-weight:normal;margin-top:10px;">
    <div id="dynamic">
      <div class="li nocufon" id="boxreports_title" style="width:auto;font-family:Arial, Helvetica, sans-serif;font-size:16px;height:auto;">Campaign Reports</div>
      <table cellpadding="0" cellspacing="0" border="0" class="display" id="reports" style="font-size:12px;font-weight:normal;">
        <thead>
          <tr style="font-size:12px;" title="Click to sort">
            <th width="0">ID</th>
            <th width="50">Campaign Name</th>
