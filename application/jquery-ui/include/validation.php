...
function validateArtistProfile($form, $file)
{
	...
	{
		$msg = '$250 Minimum. YOU ARE WORTH IT! xebura Talent may not list a fee less than $250. If you are just starting out, it is OK not to list any fee. <br>You can still receive and accept offers of any amount.';			
		return $msg;
	}
	...
	if( !checkEmpty($form['profile_url']))
	{
		...
		if (is_numeric($_SESSION['Member_Id'])) {
			$ACCOUNT_TYPE=$_SESSION['Account_Id'];
